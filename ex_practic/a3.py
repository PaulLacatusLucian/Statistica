...
print(
    f"Die theoretische Wahrscheinlichkeit, dass die Lebensdauer mehr als 1500 Stunden beträgt, beträgt: {p_more_than_1500}")
...
print(
    f"Die theoretische Wahrscheinlichkeit, dass die Lebensdauer höchstens 6500 Stunden beträgt, beträgt: {p_less_than_or_equal_6500}")
...
print(
    f"Die theoretische Wahrscheinlichkeit, dass die Lebensdauer zwischen 7500 und 10500 Stunden liegt, beträgt: {p_between_7500_and_10500}")
